 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSlideObserver() {
            ...
            const observer = new IntersectionObserver(((entries, observer) => {
                entries.forEach((entry => {
                    ...
                    if (window.innerWidth > 480.98) if (entry.isIntersecting) {
        ...
        function headerScroll() {
            ...
            let timer;
            document.querySelector(".our-serv__nav");
            ...
            const scrollListener = () => {
                ...
                const scrollTop = isPopupContent ? popupContent.scrollTop : sectionTwo ? sectionTwo.scrollTop : window.scrollY;
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (window.innerWidth <= MOBILE_BREAKPOINT) activateMobileSlider();
                ...
                requestAnimationFrame((() => {
                    entries.forEach((entry => {
                        ...
                        if (currentWidth !== lastWidth) {
                            ...
                            createSpanInWord();
                            updateIndexesRel();
                            if (currentWidth <= MOBILE_BREAKPOINT && lastWidth > MOBILE_BREAKPOINT) activateMobileSlider(); else if (currentWidth > MOBILE_BREAKPOINT && lastWidth <= MOBILE_BREAKPOINT) deactivateMobileSlider();
            ...
            if (navElement) {
                if (navLinks.length > 0) navLinks.forEach((link => {
                    link.addEventListener("click", (function(event) {
                        ...
                        if (targetElement) if (navElementPosition > 0) {
                            window.scrollTo({
                        ...
                        } else scrollToTarget(targetElement, sliderElement);
                    }));
                }));
        ...
        (function() {
            ...
            function onResize() {
                isMobile = window.innerWidth <= MOBILE_BREAKPOINT;
                if (isMobile) centerTrack(); else reset();
            }
